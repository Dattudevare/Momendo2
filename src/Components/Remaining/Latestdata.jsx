...
function Latestdata() {
    return (
        <Container maxWidth sx={{mb:"60px"}}>
            <Box component={"row"} sx={{display:{sx:"block" ,md:"flex" ,lg:"block"}, mb:"60px"}} >
                <Typography variant='h4' textAlign={"center"} fontWeight={"bold"} mt={"25px"}>
                    LATEST BLOG
                </Typography>
            ...
            <Box sx={{display:{xs:"block",md:"flex"},marginLeft:"20px",}}>
